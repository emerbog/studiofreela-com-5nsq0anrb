...
import { Loader2, ArrowLeft, Mail, Lock, AlertCircle, Info, Copy, Check } from 'lucide-react'
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
export default function Login() {
  ...
  const { login, loginWithGoogle, isGoogleAuthAvailable, googleConfigDetails } = useAuth()
        ...
        <DialogContent className="max-w-md sm:max-w-lg">
          <DialogHeader>
            ...
            <DialogDescription className="text-xs">
              ...
              habilitar o login social com o Google.
            </DialogDescription>
          </DialogHeader>

          <div className="space-y-3.5 text-xs text-foreground/90 py-2">
            <p className="leading-relaxed">
              Enquanto as credenciais do Google Cloud Console não forem inseridas nos secrets do
              projeto, o login tradicional por e-mail e senha permanece 100% ativo e funcional.
            </p>
            ...
            <div className="space-y-1 p-3 bg-muted/30 rounded-lg border border-border/70">
              ...
              <p className="text-muted-foreground text-[11px] mt-1">
                Ao registrar, a migration do backend e o botão de login ativarão o fluxo de forma
                automática.
              </p>
            </div>
          </div>
